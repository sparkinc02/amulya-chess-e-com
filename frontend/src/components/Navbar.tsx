                    ...
                    {user.picture ? (
                      <img 
                        ...
                        onError={(e) => {
                          ...
                          if (parent) {
                            parent.innerText = user.userName?.split(' ').map(w => w[0]).join('').slice(0, 2).toUpperCase() || 'U';
                          }
                        }}
                      />
                    ) : (
                      user.userName?.split(' ').map(w => w[0]).join('').slice(0, 2).toUpperCase() || 'U'
                    )}
                  </button>
                      ...
                      >
                        <div className="px-4 py-3 border-b border-border">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="font-heading text-sm font-bold">{user.userName}</p>
